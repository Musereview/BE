...
public enum PlayingErrorStatus implements BaseCode {
    ...
    MISSING_PLAYING_MODE(HttpStatus.BAD_REQUEST, "PLAYING_400_06", "연주 모드는 필수 입력값입니다."),
    MISSING_PLAYING_STATUS(HttpStatus.BAD_REQUEST, "PLAYING_400_07", "연주 상태는 필수 입력값입니다."),
    UNSUPPORTED_PLAYING_MODE(HttpStatus.BAD_REQUEST, "PLAYING_400_08", "현재 지원하지 않는 연주 모드입니다."),
