...
public interface UserLearningProgressRepository extends JpaRepository<UserLearningProgress, Long> {
    ...
    // 유저가 가장 최근에 학습한 진행 기록 1건 (학습 홈의 "최근 학습 이어서 하기"용, 동시각 충돌 방지용 id 2차 정렬)
    Optional<UserLearningProgress> findFirstByUser_UserIdOrderByLastStudiedAtDescIdDesc(Long userId);
